...
class HqRoundSliderThumbShape extends SliderComponentShape {
  /// Create a slider thumb that draws a circle.
  const HqRoundSliderThumbShape({
  ...
  void paint(
    ...
    // Removed call to super.paint as it is abstract in the superclass
